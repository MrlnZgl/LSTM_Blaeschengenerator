...
void handleEmptyButton(){
    ...
    int empytButtonReading = digitalRead(EMPTY_BUTTON_PIN);
    if (empytButtonReading == LOW && empty_button_status != 0) { 
        empty_button_status = 0;
        motorRunning = false;
        Serial.println("Empyt Button gedrückt -> Motor gestoppt, Start gesperrt");
    } else if(empytButtonReading == HIGH && button_status != 1){  // Button losgelassen
...
//     int currentButtonState = digitalRead(EMPTY_BUTTON_PIN);
...
//         currentButtonState = digitalRead(EMPTY_BUTTON_PIN);
//         if (currentButtonState != lastButtonState) {
//             lastButtonState = currentButtonState;

//             if (currentButtonState == LOW) {  // gedrückt
//                 button_status = 0;
//                 motorRunning = false;
//                 buttonStatusChanged = true; // Änderung merken

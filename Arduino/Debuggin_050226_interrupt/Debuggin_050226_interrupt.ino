...
// ----------------------------- // Motor-Berechnung (NICHT im Interrupt!) // ----------------------------- 
void updateMotorValues() { 
    static long lastStepCount = 0; // Nur aktualisieren, wenn sich etwas geändert hat 
    if (stepCount != lastStepCount) { 
        long diff = stepCount - lastStepCount; 
...
void handleClient(WiFiClient &client){
  ...
  client.println("    if (volumeFlow == 12) {");

            ...
            if (client.available()) { // If there's bytes to read from the client,
                ...
                if (c == '\n') { // If the byte is a newline character
                    ...
                    if (currentLine.length() == 0) {
                        ...
                        client.print(airFlowRate); // Setze den zuletzt eingegebenen Wert in this line
                        ...
                        if (currentLine.startsWith("GET /controlMotor?action=")) {
                            ...
                            String action = currentLine.substring(startIndex, endIndex);
                            action.trim();
                        ...
                        if (currentLine.startsWith("GET /setVolumeFlow?value=")) {
                            ...
                            // client.println(injektionVolumeFlow_ml);
                              // Setzen Sie die neue Geschwindigkeit für den Motor}
                                  // Build a response message including logs
                            ...
                            //responseMessage += "Successfully set volume flow to: " + volumeFlowString + "\n";
                            //responseMessage += "Current Volume Flow: " + String(injektionVolumeFlow_ml) + "\n";
                        ...
                        if (currentLine.startsWith("GET /getVolumeFlow")) {
                         ...
                         if (currentLine.startsWith("GET /getAirflow")) {
                            ...
                            //airFlowRate = airSensorValue*(25.0-0.0)/ (1023.0-0.0);
                            ...
                            client.println("}");
                            client.stop(); // Beende die Verarbeitung für den aktuellen Client
                            return;
                          }

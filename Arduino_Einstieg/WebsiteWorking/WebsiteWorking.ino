...
void loop() {
    ...
    // int airSensorValue = analogRead(airSensorPin);
  
    // airFlowRate = airSensorValue*(25.0-0.0)/ (71.0-0.0);
            ...
            if (client.available()) { // If there's bytes to read from the client,
                ...
                if (c == '\n') { // If the byte is a newline character
                    ...
                    if (currentLine.length() == 0) {
                        ...
                        //client.print(airSensorValue); // Setze den zuletzt eingegebenen Wert in this line
                        ...
                        if (currentLine.startsWith("GET /getVolumeFlow")) {
                         ...
                         if (currentLine.startsWith("GET /getAirflow")) {
                            ...
                            client.println("}");
                            break; // Beende die Verarbeitung für den aktuellen Client
                          }
